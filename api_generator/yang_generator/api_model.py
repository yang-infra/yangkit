...
class NamedElement(Element):
    ...
    def get_py_mod_name(self):
        ...
        if not pkg.bundle_name:
            py_mod_name = 'yangkit.models.%s' % pkg.name
        else:
            py_mod_name = 'yangkit.models.%s.%s' % (pkg.bundle_name, pkg.name)
        return py_mod_name
    ...
    def get_cpp_header_name(self):
        ...
        if pkg.curr_bundle_name == pkg.bundle_name:
            ...
            cpp_header_name = 'yangkit_%s/%s.hpp' % (pkg.bundle_name, pkg.name)
    ...
    def get_meta_py_mod_name(self):
        ...
        pkg = get_top_pkg(self)
        if not pkg.bundle_name:
            meta_py_mod_name = 'yangkit.models._meta'
        else:
            meta_py_mod_name = 'yangkit.models.%s._meta' % pkg.bundle_name
...
class Package(NamedElement):
    ...
    def sub_name(self):
        if self.bundle_name != '':
            ...
            sub = py_mod_name[len('yangkit.models.'): py_mod_name.rfind('.')]
