...
"""
from yang_generator.api_model import Package
from yang_generator.common import has_list_ancestor, is_top_level_class
...
class GetSegmentPathPrinter(object):
    ...
    def print_output(self, clazz):
        ...
        """
        self._print_get_yangkit_segment_path_body(clazz)

    def _print_get_yangkit_segment_path_body(self, clazz):
        path='"'
    ...
    def _print_get_yangkit_segment_path_trailer(self, clazz):
        self.ctx.lvl_dec()
        self.ctx.bline()
