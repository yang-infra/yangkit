...
from yang_generator.common import convert_to_reStructuredText

from .class_printer import ClassPrinter
from .enum_printer import EnumPrinter
from yang_generator.printer.file_printer import FilePrinter
...
class ModulePrinter(FilePrinter):
    ...
    def _print_static_imports(self):
        ...
        self.ctx.bline()
        self.ctx.writeln("from yangkit.types import Entity as _Entity_")
        self.ctx.writeln("from yangkit.types import EntityPath, Identity, Enum, YType, YLeaf, YLeafList, YList, LeafDataList, Bits, Empty, Decimal64")
        self.ctx.writeln(
            "from yangkit.types import Entity, EntityPath, Identity, Enum, YType, YLeaf, YLeafList, YList, LeafDataList, Bits, Empty, Decimal64")
        self.ctx.writeln("from yangkit.filters import YFilter")
        self.ctx.writeln("from yangkit.errors import YError, YModelError")
        self.ctx.writeln("from yangkit.errors.error_handler import handle_type_error as _handle_type_error")
