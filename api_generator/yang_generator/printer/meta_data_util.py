...
from yang_generator.api_model import Bits, Class, Enum, Package, Deviation
from yang_generator.builder import TypesExtractor
from yang_generator.common import convert_to_reStructuredText, get_module_name, is_config_stmt
...
def get_primitive_type_tag(typ, language):
    type_tag_map = {
        ...
        ('py', 'str'): 'str',
        ('py', 'bool'): 'bool',
        ('py', 'Decimal64'): ':py:class:`Decimal64<yangkit.types.Decimal64>`',
        ('py', 'Empty'): ':py:class:`Empty<yangkit.types.Empty>`',
        ('py', 'Enum'): ':py:class:`Enum<yangkit.types.Enum>`',
        ('py', 'Identity'): ':py:class:`Identity<yangkit.types.Identity>`',
    }
    try:
...
def get_class_bases(clazz, language):
    ...
    bases = []
    if language == 'py':
        bases.append(':py:class:`Entity<yangkit.types.Entity>`')
